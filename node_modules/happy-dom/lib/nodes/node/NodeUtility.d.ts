...
export default class NodeUtility {
     ...
     */
    static isInclusiveAncestor(ancestorNode: INode, referenceNode: INode): boolean;
    /**
     ...
     */
    static nextDecendantNode(node: INode): INode;
    /**
     ...
     * @param nodeB Node B.
     */
    static nodeEquals(nodeA: INode, nodeB: INode): boolean;
}
